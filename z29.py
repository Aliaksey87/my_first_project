...
import re
# print(re.match('^a\d+c$', 'a253c') is not None)
...
# 3. Написать функцию, которая выдирает логин из email.
# Если прислали не email вызвать исключение, в котором написать “Понимаю только email”.
